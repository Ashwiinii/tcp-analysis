...
int main(int argc, char *argv[]){
  ...
  PointToPointHelper pointL, pointR, pointRouter;
  pointL.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  pointR.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  pointRouter.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  
  PointToPointDumbbellHelper pointDumbbell = PointToPointDumbbellHelper(2, pointL, 2, pointR, pointRouter);
  ...
  PointToPointHelper pointL2, pointR2, pointRouter2;
  pointL2.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  pointR2.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  pointRouter2.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  
  PointToPointDumbbellHelper pointDumbbell2 = PointToPointDumbbellHelper(2, pointL2, 2, pointR2, pointRouter2);
  ...
  PointToPointHelper pointL3, pointR3, pointRouter3;
  pointL3.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  pointR3.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  pointRouter3.SetDeviceAttribute("DataRate", StringValue("1Gbps"));
  
  PointToPointDumbbellHelper pointDumbbell3 = PointToPointDumbbellHelper(2, pointL3, 2, pointR3, pointRouter3);
...
*/
ofstream tcpfile;
tcpfile.open("tcp_amurali5_vxin.csv");
tcpfile<<titles;
tcpfile<<th_1;
tcpfile<<th_2;
tcpfile<<th_22;
